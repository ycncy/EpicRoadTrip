...
export default function Home() {
    return (
        <div className="bg-[#5739FC] flex flex-col gap-12 min-h-screen p-16">
            <div className="w-2/5 mb-16 flex flex-col gap-4 text-center mx-auto text-white">
                    ...
                    <p className="text-lg">
                        ...
                        :
                        choisissez, détendez-vous et profitez. Planification sans effort, plaisir maximal. Prêt à
                        explorer ?
                    </p>
            </div>
            <CreateTripForm/>
            <hr className="w-10/12 mx-auto h-0.5 border-t-0 bg-white"/>
            <FetchTripForm/>
        </div>
    );
}
